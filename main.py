...
for company in test_set:
    ...
    if status != False:
        ...
        print(f'\n10-Year Operating Expenses Growth Atrributed Score: \n{scores[-1]:.2f}')
        print('━━━━━━━━━━')
    ...
    if status != False:
        ...
        print(f'\n10-Year Assets Growth Atrributed Score: \n{scores[-1]:.2f}')
        print('━━━━━━━━━━')
    ...
    if status != False:
        ...
        print(f'\n1-Year Liabilities Growth Atrributed Score: \n{scores[-1]:.2f}')
        print('━━━━━━━━━━')
    ...
    if status != False:
        ...
        print(f'\n2-Year Liabilities Growth Atrributed Score: \n{scores[-1]:.2f}')
        print('━━━━━━━━━━')
    ...
    if status != False:
        ...
        print(f'\n5-Year Liabilities Growth Atrributed Score: \n{scores[-1]:.2f}')
        print('━━━━━━━━━━')
    ...
    if status != False:
        ...
        print(f'\n10-Year Liabilities Growth Atrributed Score: \n{scores[-1]:.2f}')
        print('━━━━━━━━━━')

    # sleep(0.2)

    status = one_yr_share_count_growth(company_balance_sheet)

    if status != False:
        scores.append(float(one_yr_share_count_growth_score(company_balance_sheet)))
        print(f'1-Year Share Count Growth: \n{status:.2f}%')
        print(f'\n1-Year Share Count Growth Atrributed Score: \n{scores[-1]:.2f}')
        print('━━━━━━━━━━')

    # sleep(0.2)

    status = two_yr_share_count_growth(company_balance_sheet)

    if status != False:
        scores.append(float(two_yr_share_count_growth_score(company_balance_sheet)))
        print(f'2-Year Share Count Growth: \n{status:.2f}%')
        print(f'\n2-Year Share Count Growth Atrributed Score: \n{scores[-1]:.2f}')
        print('━━━━━━━━━━')
    
    # sleep(0.2)

    status = five_yr_share_count_growth(company_balance_sheet)

    if status != False:
        scores.append(float(five_yr_share_count_growth_score(company_balance_sheet)))
        print(f'5-Year Share Count Growth: \n{status:.2f}%')
        print(f'\n5-Year Share Count Growth Atrributed Score: \n{scores[-1]:.2f}')
        print('━━━━━━━━━━')
    ...
    if status != False:
        ...
        print(f'\n10-Year Share Count Growth Atrributed Score: \n{scores[-1]:.2f}')
        print('━━━━━━━━━━')
